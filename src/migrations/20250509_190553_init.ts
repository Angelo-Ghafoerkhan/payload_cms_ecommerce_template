...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_image_with_text_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_step_item_grid_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"rich_text" jsonb
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_step_item_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_image_with_text_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_step_item_grid_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"rich_text" jsonb,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_step_item_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "products_specifications_specs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "carts_line_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"product_id" integer NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "product_categories_breadcrumbs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"doc_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "header_nav_items_dropdown_children" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "header_nav_items_mega_children_group_children" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "header_nav_items_mega_children" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "users" ADD CONSTRAINT "users_cart_id_carts_id_fk" FOREIGN KEY ("cart_id") REFERENCES "public"."carts"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "faqs_questions_order_idx" ON "faqs_questions" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "faqs_questions_parent_id_idx" ON "faqs_questions" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_faq_block_faqs_idx" ON "pages_blocks_faq_block" USING btree ("faqs_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_gallery_idx" ON "pages_blocks_gallery" USING btree ("gallery_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_with_text_block_order_idx" ON "pages_blocks_image_with_text_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_with_text_block_parent_id_idx" ON "pages_blocks_image_with_text_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_with_text_block_path_idx" ON "pages_blocks_image_with_text_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_step_item_grid_items_order_idx" ON "pages_blocks_step_item_grid_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_step_item_grid_items_parent_id_idx" ON "pages_blocks_step_item_grid_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_step_item_grid_order_idx" ON "pages_blocks_step_item_grid" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_step_item_grid_parent_id_idx" ON "pages_blocks_step_item_grid" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_step_item_grid_path_idx" ON "pages_blocks_step_item_grid" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_faq_block_faqs_idx" ON "_pages_v_blocks_faq_block" USING btree ("faqs_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_gallery_idx" ON "_pages_v_blocks_gallery" USING btree ("gallery_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_with_text_block_order_idx" ON "_pages_v_blocks_image_with_text_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_with_text_block_parent_id_idx" ON "_pages_v_blocks_image_with_text_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_with_text_block_path_idx" ON "_pages_v_blocks_image_with_text_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_step_item_grid_items_order_idx" ON "_pages_v_blocks_step_item_grid_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_step_item_grid_items_parent_id_idx" ON "_pages_v_blocks_step_item_grid_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_step_item_grid_order_idx" ON "_pages_v_blocks_step_item_grid" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_step_item_grid_parent_id_idx" ON "_pages_v_blocks_step_item_grid" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_step_item_grid_path_idx" ON "_pages_v_blocks_step_item_grid" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "users_cart_idx" ON "users" USING btree ("cart_id");
  ...
  CREATE INDEX IF NOT EXISTS "products_specifications_specs_order_idx" ON "products_specifications_specs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "products_specifications_specs_parent_id_idx" ON "products_specifications_specs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "products_slug_idx" ON "products" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "products_primary_category_idx" ON "products" USING btree ("primary_category_id");
  ...
  CREATE INDEX IF NOT EXISTS "carts_line_items_order_idx" ON "carts_line_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "carts_line_items_parent_id_idx" ON "carts_line_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "carts_line_items_product_idx" ON "carts_line_items" USING btree ("product_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "carts_customer_idx" ON "carts" USING btree ("customer_id");
  ...
  CREATE INDEX IF NOT EXISTS "product_categories_breadcrumbs_order_idx" ON "product_categories_breadcrumbs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "product_categories_breadcrumbs_parent_id_idx" ON "product_categories_breadcrumbs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "product_categories_breadcrumbs_doc_idx" ON "product_categories_breadcrumbs" USING btree ("doc_id");
  ...
  CREATE INDEX IF NOT EXISTS "subscriptions_rels_subscription_orders_id_idx" ON "subscriptions_rels" USING btree ("subscription_orders_id");
  CREATE INDEX IF NOT EXISTS "subscription_orders_user_idx" ON "subscription_orders" USING btree ("user_id");
  CREATE INDEX IF NOT EXISTS "subscription_orders_subscription_idx" ON "subscription_orders" USING btree ("subscription_id");
  CREATE INDEX IF NOT EXISTS "subscription_orders_updated_at_idx" ON "subscription_orders" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "subscription_orders_created_at_idx" ON "subscription_orders" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_subscription_orders_id_idx" ON "payload_locked_documents_rels" USING btree ("subscription_orders_id");
  ...
  CREATE INDEX IF NOT EXISTS "header_nav_items_dropdown_children_order_idx" ON "header_nav_items_dropdown_children" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_nav_items_dropdown_children_parent_id_idx" ON "header_nav_items_dropdown_children" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "header_nav_items_mega_children_group_children_order_idx" ON "header_nav_items_mega_children_group_children" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_nav_items_mega_children_group_children_parent_id_idx" ON "header_nav_items_mega_children_group_children" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "header_nav_items_mega_children_order_idx" ON "header_nav_items_mega_children" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_nav_items_mega_children_parent_id_idx" ON "header_nav_items_mega_children" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "header_nav_items_mega_children_standard_standard_image_idx" ON "header_nav_items_mega_children" USING btree ("standard_image_id");
  CREATE INDEX IF NOT EXISTS "header_nav_items_mega_children_group_group_image_idx" ON "header_nav_items_mega_children" USING btree ("group_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "header_rels_product_categories_id_idx" ON "header_rels" USING btree ("product_categories_id");
  CREATE INDEX IF NOT EXISTS "header_rels_products_id_idx" ON "header_rels" USING btree ("products_id");
  ...
  CREATE INDEX IF NOT EXISTS "footer_rels_product_categories_id_idx" ON "footer_rels" USING btree ("product_categories_id");
  CREATE INDEX IF NOT EXISTS "footer_rels_products_id_idx" ON "footer_rels" USING btree ("products_id");
  CREATE INDEX IF NOT EXISTS "settings_logo_light_idx" ON "settings" USING btree ("logo_light_id");
  CREATE INDEX IF NOT EXISTS "settings_logo_dark_idx" ON "settings" USING btree ("logo_dark_id");
